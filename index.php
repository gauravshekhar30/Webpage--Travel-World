...
<section class="m-5">
	...
	<div class="row mt-5">
		...
		<div class="col-lg-6 col-12">
			<h2 class="display-4"> Get Your Plans Ready. </h2>
			<p class="py-4"> We live in a world that is full of beauty, charm and adventure. There is no end to the adventures we can have if only we seek them with our eyes open. </p>
			 ...
			 <div class="col-lg-4 col-md-4 col-12">
			 	<div class="card" >
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">Book your Ticket here.</p>
			  ...
			  <div class="col-lg-4 col-md-4 col-12">
			 	<div class="card" >
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">Check-In in the Best Hotels.</p>
				    <a href="#" class="btn btn-primary">Book</a>
				  </div>
				</div>
			 </div>
			  <div class="col-lg-4 col-md-4 col-12">
			 	<div class="card" >
				  <img class="card-img-top" src="images/taxi.jpeg" alt="Card image">
				  <div class="card-body">
				    <h4 class="card-title">Taxi/Cabs</h4>
				    <p class="card-text">Book your Taxi in Advance.</p>
				    <a href="#" class="btn btn-primary">Book</a>
				  </div>
				</div>
			 </div>
...
<section class="m-5">
	...
	<div class="row mt-5">
		...
		<div class="col-lg-4 col-md-4 col-12  mb-4">
			...
			<img src="images/c4.jpg" class="img-fluid">
		</div><div class="col-lg-4 col-md-4 col-12  mb-4">
...
<footer>
	<div class=" bg-dark text-center text-capitalize">
		<h5 class="py-3 text-white">@Travel World</h5>
	</div>
</footer>
